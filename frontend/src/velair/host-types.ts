...
export type VelairViewHost = {
  ...
  _formatScheduleTime(value: string): string;
  ...
  _presetModeOptions(source?: BlockDraftSource): string[];
  ...
  _swingHorizontalModeOptions(source?: BlockDraftSource): string[];
  _swingModeOptions(source?: BlockDraftSource): string[];
