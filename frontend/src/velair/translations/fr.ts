export const fr = {
  "climateCardThermostatControls": "Commandes du thermostat",
  "climateCardShowControlMode": "Afficher le contrôle Automatique/Manuel",
  "climateCardShowTargetControl": "Afficher le réglage de la consigne",
  "climateCardShowHvacModeControl": "Afficher le sélecteur de mode HVAC",
  "climateCardShowNativeClimateLink": "Afficher le lien vers le thermostat dans Home Assistant",
  "climateCardThermostatControlsDescription": "La consigne et le mode HVAC ne peuvent être modifiés que pendant un ajustement manuel confirmé. Le lien Home Assistant ouvre toutes les commandes natives du thermostat.",
  "climateCardTargetTemperature": "Température cible",
  "climateCardLowerTarget": "Consigne basse",
  "climateCardUpperTarget": "Consigne haute",
  "climateCardDecreaseTarget": "Diminuer la consigne",
  "climateCardIncreaseTarget": "Augmenter la consigne",
  "climateCardAdjustManually": "Ajuster manuellement",
  "climateCardOpenInHomeAssistant": "Ouvrir dans Home Assistant",
  "climateCardHumiditySource": "Source d’humidité",
  "climateCardHumidityClimateSource": "Humidité fournie par le thermostat",
  "climateCardHumiditySourceDescription": "Choisissez un capteur d’humidité Home Assistant pour remplacer la mesure du thermostat et son raccourci vers l’historique.",
  "climateCardOpenMetricHistory": "Ouvrir l’historique de {metric}",
  "climateCardControlsAutomaticHint": "Démarrez un ajustement manuel pour modifier directement le thermostat.",
  "climateCardManualAdjustmentUnavailable": "L’ajustement manuel n’est pas disponible actuellement.",
  "climateCardControlsUnavailable": "Les commandes directes sont indisponibles tant que le thermostat est indisponible.",
  "climateCardControlsBlockedBoost": "Les commandes directes sont indisponibles pendant le renfort.",
  "climateCardControlsBlockedPause": "Les commandes directes sont indisponibles pendant une pause.",
  "climateCardControlsBlockedStopped": "Les commandes directes sont indisponibles lorsque la zone est arrêtée.",
  "climateCardControlsMissingStep": "Ce thermostat ne publie pas de pas de température valide ; utilisez ses commandes natives Home Assistant.",
  "climateCardThermostatActionFailed": "Impossible d’appliquer la modification du thermostat",
 "addBlock": "Ajouter un bloc",
  "externalConditionProfilesSupported": "Les programmes Par défaut, Profil et Mode sont pris en charge", "profileExternalScheduleOnly": "Les zones externes prennent uniquement en charge les programmes Par défaut, Profil ou Mode. Les pauses et les actions Velair directes restent indisponibles.", "profileExternalMaxChanges": "{climate} dépasse la limite de {count} changements du contrôleur le {day}.", "profileExternalTimeGrid": "{climate} doit utiliser des intervalles de {minutes} minutes le {day}.", "profileExternalUnsupportedBlock": "{climate} contient un bloc que le contrôleur externe ne peut pas représenter.",
  "externalControllersInUse": "Contrôleurs externes utilisés", "externalConditionDefaultOnly": "Programmes par défaut uniquement", "externalConditionHvacModes": "Modes HVAC pris en charge : {modes}", "externalConditionTargetTypes": "Types de cible pris en charge : {types}", "externalConditionActions": "Actions de programme prises en charge : {actions}", "externalConditionTurnOffUnsupported": "Les blocs d’arrêt ne sont pas pris en charge", "externalConditionOptionFields": "Options climatiques prises en charge : {fields}", "externalConditionOptionsUnsupported": "Les champs d’options climatiques ne sont pas pris en charge", "externalConditionMaxChanges": "Maximum de {count} changements de programme par jour", "externalConditionTimeGrid": "Les heures doivent utiliser des intervalles de {minutes} minutes", "externalConditionMidnightContinuityCounts": "Un changement implicite de continuité à minuit compte dans le maximum quotidien", "externalConditionsUnavailable": "Les conditions du contrôleur sont indisponibles.",
  "externalCapability_action_set_temperature": "Régler la température", "externalCapability_action_set_hvac_mode": "Modifier uniquement le mode HVAC", "externalCapability_action_turn_off": "Éteindre", "externalCapability_hvac_heat": "Chauffage", "externalCapability_hvac_cool": "Refroidissement", "externalCapability_target_scalar": "Température cible unique", "externalCapability_target_range": "Plage de températures cibles",
  "externalProviderAvailability": "Contrôleur : {state}", "externalProviderAvailable": "disponible", "externalProviderUnavailable": "indisponible", "externalPublication_publishing": "Le programme effectif est publié vers l’intégration externe.", "externalPublication_published": "L’intégration externe a accepté le programme effectif.", "externalPublication_failed": "La publication du programme a échoué.", "overviewExternalExecutionProvider": "Contrôleur externe : {provider}", "overviewExternalInfoAction": "À propos de l’exécution externe via {provider}", "overviewExternalStatusPublishing": "Publication en cours", "overviewExternalStatusAccepted": "Accepté", "overviewExternalStatusFailed": "Échec", "overviewExternalStatusUnavailable": "Indisponible", "overviewExternalProviderUnavailable": "L’intégration externe est actuellement indisponible. Velair reste inactif pour ce thermostat.",
  "externalSystems": "Systèmes externes", "externalSystemsDescription": "Choisissez qui exécute le programme hebdomadaire effectif pour les thermostats compatibles. Les zones externes ne sont jamais contrôlées directement par Velair.",
  "externalExecutionVelair": "Velair (exécution locale)", "externalExecutionLocal": "Exécuté par Velair", "externalExecutionEnabled": "Exécution externe du programme activée", "externalExecutionDisabled": "Exécution du programme par Velair activée", "externalScheduleRequired": "Créez et enregistrez un programme comportant au moins un bloc de température avant d’activer l’exécution externe.", "externalSwitchpointUsage": "{used} sur {max} points de commutation du contrôleur", "externalSwitchpointBreakdown": "{count} blocs programmés", "externalSwitchpointBreakdownContinuity": "{count} blocs programmés + 1 point de continuité à minuit", "externalActionsInactive": "Les actions Velair sont inactives car ce thermostat est exécuté par un système externe.",
  "overviewZoneExternal": "Exécution externe", "overviewExternalLabel": "Externe", "overviewExternalExecutionDescription": "La chronologie planifiée est exécutée par le contrôleur externe. Velair n’envoie aucune action climatique à cette zone.", "overviewExternalZonesUnaffected": "{count} zone(s) exécutée(s) en externe ne sont pas affectée(s) par les actions Velair.", "manualUnavailableExternalExecution": "Le contrôle manuel est indisponible pour les thermostats exécutés en externe.",
  "externalChangePolicy": "Réglages externes",
  "externalChangePolicyDescription": "Choisissez la réaction de Velair après un changement de mode ou de consigne en dehors de Velair. Maintenir automatique réapplique l’intention Velair actuelle ; les autres options démarrent le contrôle Manuel. Les changements s’appliquent au prochain réglage externe. Un passage explicite en Manuel reste actif jusqu’à sa reprise.",
  ...
  "targetTempStepFallback": "Pas de température",
  "targetTempStepFallbackDescription": "Home Assistant ne fournit pas le pas de consigne de ce thermostat. Velair utilise cette valeur jusqu’à ce que le thermostat en publie une.",
  "targetTempStepFallbackInfoAction": "À propos du pas de température",
  "targetTempStepSaved": "Pas de température enregistré",
  ...
  "manualUnavailableProfilePause": "Le profil actif met ce thermostat en pause.",
  ...
  "cloneAction": "Copier",
  "clonePresetLabel": "Sélection rapide des jours",
  "clonePresetWeekdays": "Lun–Ven",
  "clonePresetWeekend": "Week-end",
  "clonePresetAll": "Tous les jours",
  "clonePresetClear": "Effacer la sélection",
  "cancel": "Annuler",
  "close": "Fermer",
  ...
  "climateCardOutdoorSensorDescription": "Mesure extérieure purement visuelle pour la comparer à la température intérieure actuelle. Elle ne modifie pas le contrôle Velair.",
  "climateCardHeaderOptions": "En-tête",
  "climateCardShowStateBar": "Afficher la barre d’état",
  "climateCardShowName": "Afficher le nom du thermostat",
  "climateCardCustomName": "Nom personnalisé du thermostat",
  "climateCardShowOperation": "Afficher l’état de fonctionnement",
  "climateCardShowCurrentTemperature": "Afficher la température actuelle",
  "climateCardShowCurrentHumidity": "Afficher l’humidité actuelle",
  "climateCardShowOutdoorTemperature": "Afficher la température extérieure",
  "climateCardShowWindows": "Afficher les fenêtres",
  "climateCardWindowsDescription": "Les capteurs de fenêtre sont uniquement visuels et ne contrôlent pas Velair. Utilisez votre propre automatisation Home Assistant ou le blueprint Velair si l’ouverture d’une fenêtre doit mettre ce thermostat en pause.",
  "climateCardWindowBlueprintLink": "Voir la documentation et importer le blueprint",
  "climateCardTimelineShowTitle": "Afficher le titre de la chronologie",
  "climateCardTimelineShowProfile": "Afficher le profil actif",
  "climateCardTimelineShowMode": "Afficher le mode actif",
  "climateCardResetName": "Restaurer le nom du thermostat",
  "climateCardActions": "Actions",
  "climateCardShowBoostAction": "Afficher l’action de forçage",
  "climateCardShowPauseAction": "Afficher l’action Pause et Reprendre",
  "climateCardVelairActionsDescription": "Le forçage et la pause sont fournis par Velair. Leur comportement, leur libellé et leurs icônes ne sont pas personnalisables.",
  "climateCardCustomActions": "Actions personnalisées",
  "climateCardActionsOrderDescription": "Réorganisez les actions Velair et les scripts Home Assistant. Les actions automatiques utilisent jusqu’à trois emplacements directs ; choisissez Menu Plus pour conserver une action dans Plus. Cette limite n’est pas personnalisable.",
  "climateCardActionPlacement": "Emplacement",
  "climateCardActionPlacementAuto": "Automatique",
  "climateCardActionPlacementMore": "Menu Plus",
  "climateCardActionPlacementAutoDescription": "Utilise l’un des trois premiers emplacements directs disponibles. S’ils sont occupés, l’action passe dans Plus.",
  "climateCardActionPlacementMoreDescription": "Conserve toujours cette action dans le menu Plus, quel que soit son ordre.",
  "climateCardRemoveCustomAction": "Retirer le raccourci de la carte",
  "climateCardExpandAction": "Modifier {name}",
  "climateCardCollapseAction": "Fermer les réglages de {name}",
  "climateCardCollapseCurrentState": "Réduire l’état actuel",
  "climateCardExpandCurrentState": "Développer l’état actuel",
  "climateCardCollapsedByDefault": "Réduit par défaut",
  "climateCardCollapseSection": "Réduire {name}",
  "climateCardExpandSection": "Développer {name}",
  "climateCardProvidedByVelair": "Fourni par Velair · le comportement n’est pas personnalisable",
  "climateCardHideActionName": "Masquer le nom de l’action",
  "climateCardCustomActionsDescription": "Ajoutez des scripts Home Assistant. La logique reste gérée par Home Assistant.",
  "climateCardAddCustomAction": "Ajouter une action personnalisée",
  "climateCardNoScripts": "Créez un script Home Assistant avant d’ajouter une action.",
  "climateCardCustomActionName": "Nom",
  "climateCardCustomActionScript": "Script Home Assistant",
  "climateCardCustomActionIcon": "Icône",
  "climateCardCustomActionColor": "Couleur de l’icône",
  "climateCardCustomActionConfirmation": "Demander confirmation avant l’exécution",
  "climateCardScriptUnavailable": "Script indisponible",
  "climateCardOpenVelairMenu": "Ouvrir Velair",
  "climateCardConfirmScriptAction": "Exécuter {name} ?",
  "climateCardScriptExecuted": "{name} démarré",
  "climateCardPreconditioningDisplay": "Affichage du préconditionnement",
  "cardViewClimate": "Thermostat : état et contrôle", "climateCardConfiguration": "Carte de thermostat", "climateCardConfigurationDescription": "Affiche un thermostat géré avec son état, le contexte Velair et des capteurs facultatifs du tableau de bord.", "climateCardManagedClimate": "Thermostat géré", "climateCardOutdoorSensor": "Capteur de température extérieure (facultatif)", "climateCardWindowDisplay": "Affichage des fenêtres", "climateCardWindowGrouped": "Grouper par état", "climateCardWindowIndividual": "Afficher séparément", "climateCardRoomAssistDisplay": "Affichage Room Assist", "climateCardDisplayBoth": "Texte et graphique", "climateCardDisplayChart": "Graphique", "climateCardDisplayText": "Texte", "climateCardAddWindow": "Ajouter une fenêtre", "climateCardWindows": "Fenêtres", "climateCardShowTimeline": "Afficher la chronologie du jour", "climateCardShowComfort": "Afficher le confort", "climateCardShowCollapsedComfortReadings": "Afficher les relevés supplémentaires une fois réduit", "climateCardShowRoomAssist": "Afficher Room Assist", "climateCardShowPreconditioning": "Afficher le préconditionnement", "climateCardShowActions": "Afficher les actions", "climateCardOpenVelair": "Ouvrir Velair", "climateCardAvailable": "Disponible", "climateCardUnavailable": "Indisponible", "climateCardCurrentState": "État actuel", "climateCardOutdoor": "Température extérieure", "climateCardOutdoorWarmer": "{delta} de plus qu'à l'intérieur", "climateCardOutdoorColder": "{delta} de moins qu'à l'intérieur", "climateCardWindowsOpen": "{count} ouvertes", "climateCardWindowsClosed": "{count} fermées", "climateCardWindowsUnavailable": "{count} indisponibles", "climateCardProfilePause": "Le profil {profile} met ce thermostat en pause", "climateCardRoomReading": "Mesure de la pièce", "climateCardAppliedSetpoint": "Consigne appliquée", "climateCardClimateReading": "Mesure du thermostat", "climateCardRoomAssistNotConfigured": "Non configuré", "climateCardRoomAssistDisabled": "Désactivé", "climateCardRoomAssistIdle": "En attente", "climateCardRoomAssistReady": "Prêt", "climateCardRoomAssistAssisting": "Correction active", "climateCardRoomAssistHolding": "Maintien", "climateCardRoomAssistBlocked": "Bloqué", "climateCardRoomAssistUnavailable": "Indisponible", "climateCardExternalManaged": "Géré par {provider}", "climateCardExternalControl": "Contrôle externe", "climateCardManagePause": "Gérer la pause", "climateCardConfigureBoost": "Configurer le renfort", "climateCardBoostStarted": "Renfort démarré", "climateCardBoostCancelled": "Renfort annulé", "climateCardZonePaused": "Thermostat en pause", "climateCardZoneResumed": "Thermostat relancé", "climateCardActionFailed": "Impossible de terminer l'action", "resumeAutomaticControl": "Reprendre l'automatique", "cancelBoost": "Annuler le renfort", "more": "Plus", "manualControl": "Contrôle manuel", "scheduled": "Programmé", "enabled": "Activé", "unavailable": "Indisponible", "unknown": "Inconnu", "none": "Aucun", "remove": "Supprimer",
  ...
  "comfortConfiguration": "Configuration du confort",
  "comfortConfigurationDescription": "Sources des capteurs, plages de confort et fraîcheur des données.",
  "comfortDewPoint": "Dew point",
  "comfortDewPointDescription": "Les surfaces à une température égale ou inférieure au point de rosée peuvent accumuler de la condensation. Velair ne détecte ni leur température ni la condensation.",
  "comfortDewPointBelowRoom": "Le point de rosée est {difference} sous l’air ambiant.",
  "comfortDewPointAboveRoom": "Le point de rosée est {difference} au-dessus de l’air ambiant.",
  "comfortAbsoluteHumidity": "Absolute humidity",
  "comfortAbsoluteHumidityDescription": "The actual amount of water vapour in the air.",
  "comfortAbsoluteHumidityNeutral": "Humidité absolue : {value}.",
  ...
  "comfortHumidexRangeBelow": "Sous la plage de température configurée",
  "comfortHumidexRangeWithin": "Dans la plage de température configurée",
  "comfortHumidexRangeAbove": "Au-dessus de la plage de température configurée",
  "comfortHumidexRangeUnknown": "Position par rapport à la plage configurée indisponible",
  "comfortHumidexScaleAria": "Air {air}. Humidex {humidex}. {position}.",
  "comfortHumidexWarmerRelation": "L’Humidex indique une chaleur perçue {delta} supérieure à la température ambiante.",
  "comfortHumidexCoolerRelation": "L’Humidex est inférieur de {delta} à la température ambiante.",
  "comfortHumidexNeutralRelation": "L’Humidex correspond à la température ambiante.",
  "comfortRangeWithin": "Dans les plages configurées",
  "comfortRangeOutside": "Hors des plages configurées",
  "comfortRangeMixed": "Indicateurs thermiques divergents",
  "comfortRangeUnavailable": "Données limitées",
  ...
  "comfortInsightCo2Elevated": "Le CO2 dépasse le seuil d’attention configuré.",
  "comfortInsightCo2Poor": "Le CO2 dépasse le seuil configuré de mauvaise qualité de l’air.",
  "comfortInsightHumidexWarmer": "L’humidité augmente la chaleur ressentie de {delta}.",
  "comfortAir": "Air",
  ...
  "comfortMaximum": "Max",
  "comfortMinimum": "Min",
  "comfortModel": "Modèle de confort",
  "comfortModelSimple": "Plages simples",
  "comfortModelSimpleDescription": "Utilise la même plage d'humidité pour toutes les températures confortables.",
  "comfortModelTemperatureAware": "Plages selon la température",
  "comfortModelTemperatureAwareDescription": "Adapte la plage d'humidité acceptable entre les extrémités fraîche et chaude de la plage de température.",
  "comfortTemperatureAwareHumidityRanges": "Plages d'humidité selon la température",
  "comfortAtMinimumTemperature": "À la limite la plus fraîche",
  "comfortAtMaximumTemperature": "À la limite la plus chaude",
  "comfortEffectiveHumidityRange": "À {temperature}, la plage d'humidité de confort est de {minimum} à {maximum}%.",
  ...
  "entityDiagnosticNotClimate": "Cette entité n’appartient pas au domaine climate de Home Assistant",
  ...
  "noManagedEntities": "Aucun thermostat géré trouvé.",
  ...
  "roomSensorDeadbandZoneHelpGeneric": "Le mode effectif du thermostat détermine comment Room Assist utilise cette zone morte.",
  ...
  "roomSensorClimateTargetHelp": "La consigne du thermostat est la valeur actuellement indiquée par l’entité ; ce n’est pas la température cible de la pièce.",
  "roomSensorClimateTargetAppliedHelp": "La consigne du thermostat est la valeur temporaire envoyée par Velair à l’entité lorsque Room Assist est actif ; ce n’est pas la température cible de la pièce.",
  ...
  "diagnosticsEntityUnavailable": "Le thermostat est indisponible.",
  "diagnosticsEntityUnknown": "Le thermostat indique un état inconnu.",
  ...
  "diagnosticsPreconditioning": "Anticipation",
  ...
  "diagnosticsDeliveryRetrying": "Velair réessaie d’envoyer la dernière consigne au thermostat.",
  "diagnosticsDeliveryExhausted": "La limite de tentatives d’envoi a été atteinte.",
  "diagnosticsDeliveryInvalidIntent": "La consigne actuelle du thermostat n’a pas pu être déterminée.",
  ...
  "diagnosticsUnits": "Thermostats gérés",
  "diagnosticsNoUnits": "Aucun thermostat géré n’est disponible pour le diagnostic.",
  ...
  "diagnosticsLogClimate": "Thermostat",
  ...
  "diagnosticsHistorySourceCount": "{count} thermostats",
  "diagnosticsHistorySourceCountWithVelair": "{count} thermostats + Velair",
  ...
  "diagnosticsHistoryAllSources": "Tous les thermostats + Velair",
  ...
  "diagnosticsHistoryCategoryControlDescription": "Programmes, profils, modes, forçages, pauses, réglages externes et changements de contrôle automatique/manuel.",
  ...
  "diagnosticsHistoryCategoryPreconditioning": "Anticipation",
  "diagnosticsHistoryCategoryPreconditioningDescription": "Plans, annulations et observations d’apprentissage de l’anticipation.",
  "diagnosticsHistoryCategoryComfort": "Confort",
  "diagnosticsHistoryCategoryComfortDescription": "Changements des conditions de confort évaluées localement.",
  "diagnosticsHistoryCategoryDelivery": "Envoi au thermostat",
  "diagnosticsHistoryCategoryDeliveryDescription": "Commandes du thermostat échouées, réessayées, épuisées ou annulées.",
  "diagnosticsHistoryCategoryAvailability": "Disponibilité",
  "diagnosticsHistoryCategoryAvailabilityDescription": "Thermostats gérés qui deviennent indisponibles, inconnus ou à nouveau disponibles.",
  ...
  "diagnosticsEventBoostEnded": "Forçage terminé",
  "diagnosticsEventBoostStarted": "Forçage démarré",
  "diagnosticsEventClimateTargetApplied": "Consigne du thermostat appliquée",
  ...
  "diagnosticsEventProfileChanged": "Profil modifié",
  ...
  "diagnosticsEventComfortAssessmentChanged": "Évaluation du confort modifiée",
  "diagnosticsEventPreconditioningObservationRecorded": "Observation d’anticipation enregistrée",
  "diagnosticsEventPreconditioningPlanCancelled": "Plan d’anticipation annulé",
  "diagnosticsEventPreconditioningPlanUpdated": "Plan d’anticipation mis à jour",
  ...
  "diagnosticsExportExplanation": "La vue locale utilise les ID locaux réels. Gardez cette option activée pour remplacer les ID des thermostats et des capteurs par des alias stables dans le rapport.",
  "diagnosticsRedactEntityIds": "Remplacer les ID d’entité par des alias",
  "diagnosticsOperationalIdsAlwaysRedacted": "Les identifiants de profil, mode et pause sont toujours supprimés.",
  ...
  "diagnosticsSelectUnit": "Sélectionnez un thermostat pour afficher son diagnostic.",
  "diagnosticsDeliverySuccess": "Commande transmise avec succès",
  "diagnosticsScheduleSourceProfilePause": "Pause du profil",
  "diagnosticsOverrideTurnOff": "Éteindre le thermostat",
  ...
  "temperatureStepNotReportedDescription": "Ce thermostat ne publie pas target_temp_step. Velair utilise la valeur de secours configurée pour la zone dans Réglages.",
  ...
  "chooseModeForDeviceControlled": "Choisissez un mode HVAC avant d’utiliser la consigne contrôlée par l’appareil",
  ...
  "climateCardRoomAssistSummaryNotConfigured": "Sélectionnez un capteur de température ambiante avant d’utiliser Room Assist.",
  "climateCardRoomAssistSummaryDisabled": "Room Assist est configuré, mais actuellement désactivé.",
  "climateCardRoomAssistSummaryIdle": "En attente d’une consigne programmée active et compatible.",
  "climateCardRoomAssistSummaryReady": "Prêt à ajuster la consigne lorsque la température ambiante l’exige.",
  "climateCardRoomAssistSummaryAssisting": "Ajuste la consigne pour rapprocher la pièce de la consigne programmée.",
  "climateCardRoomAssistSummaryHolding": "Maintient stable la consigne Room Assist actuelle.",
  "climateCardRoomAssistSummaryBlocked": "En attente pendant qu’une autre action Velair est prioritaire.",
  "climateCardRoomAssistSummaryUnavailable": "Room Assist ne peut pas contrôler ce thermostat pour le moment.",
  "climateCardPreconditioningActive": "Actif",
  "climateCardRoomAssistSummaryAssistingAdjusted": "Applique une consigne de {applied} pour rapprocher la pièce de son objectif programmé de {target}.",
  ...
  "comfortDataSources": "Sources de données",
  "comfortModelGuided": "Plage psychrométrique guidée",
  "comfortModelGuidedDescription": "Adapte l’humidité relative à la plage de température à partir d’une seule plage de référence.",
  "comfortModelGuidedReference": "La plage d’humidité sert de référence à {temperature} ; Velair adapte la courbe cible aux autres températures.",
  "comfortModelHumidityRequired": "Une source d’humidité est nécessaire pour sélectionner ce modèle.",
  "comfortGuidedHumidityReference": "Plage d’humidité de référence",
  "comfortPreferences": "Préférences de confort",
} as const;
