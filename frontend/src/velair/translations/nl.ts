export const nl = {
  "climateCardThermostatControls": "Thermostaatbediening",
  "climateCardShowControlMode": "Automatische/handmatige bediening tonen",
  "climateCardShowTargetControl": "Doeltemperatuurbediening tonen",
  "climateCardShowHvacModeControl": "HVAC-modusselectie tonen",
  "climateCardShowNativeClimateLink": "Link naar de thermostaat in Home Assistant tonen",
  "climateCardThermostatControlsDescription": "De doeltemperatuur en HVAC-modus kunnen alleen tijdens een bevestigde handmatige aanpassing worden gewijzigd. De Home Assistant-link opent alle ingebouwde thermostaatbediening.",
  "climateCardTargetTemperature": "Doeltemperatuur",
  "climateCardLowerTarget": "Ondergrens",
  "climateCardUpperTarget": "Bovengrens",
  "climateCardDecreaseTarget": "Doeltemperatuur verlagen",
  "climateCardIncreaseTarget": "Doeltemperatuur verhogen",
  "climateCardAdjustManually": "Handmatig aanpassen",
  "climateCardOpenInHomeAssistant": "Openen in Home Assistant",
  "climateCardHumiditySource": "Vochtigheidsbron",
  "climateCardHumidityClimateSource": "Vochtigheid van de thermostaat",
  "climateCardHumiditySourceDescription": "Kies een vochtigheidssensor uit Home Assistant om zowel de thermostaatmeting als de snelkoppeling naar de geschiedenis te vervangen.",
  "climateCardOpenMetricHistory": "Geschiedenis van {metric} openen",
  "climateCardControlsAutomaticHint": "Start een handmatige aanpassing om de thermostaat direct te wijzigen.",
  "climateCardManualAdjustmentUnavailable": "Handmatige aanpassing is momenteel niet beschikbaar.",
  "climateCardControlsUnavailable": "Directe bediening is niet beschikbaar zolang de thermostaat niet beschikbaar is.",
  "climateCardControlsBlockedBoost": "Directe bediening is niet beschikbaar tijdens een versterking.",
  "climateCardControlsBlockedPause": "Directe bediening is niet beschikbaar tijdens een pauze.",
  "climateCardControlsBlockedStopped": "Directe bediening is niet beschikbaar wanneer de zone is gestopt.",
  "climateCardControlsMissingStep": "Deze thermostaat publiceert geen geldige temperatuurstap; gebruik de ingebouwde Home Assistant-bediening.",
  "climateCardThermostatActionFailed": "De thermostaatwijziging kon niet worden toegepast",
 "addBlock": "Blok toevoegen",
  "externalConditionProfilesSupported": "Schema's voor Standaard, Profiel en Modus worden ondersteund", "profileExternalScheduleOnly": "Externe zones ondersteunen alleen schema's voor Standaard, Profiel of Modus. Pauzes en directe Velair-acties blijven niet beschikbaar.", "profileExternalMaxChanges": "{climate} overschrijdt op {day} de controllerlimiet van {count} wijzigingen.", "profileExternalTimeGrid": "{climate} moet op {day} intervallen van {minutes} minuten gebruiken.", "profileExternalUnsupportedBlock": "{climate} bevat een blok dat de externe controller niet kan weergeven.",
  "externalControllersInUse": "Gebruikte externe controllers", "externalConditionDefaultOnly": "Alleen standaardschema's", "externalConditionHvacModes": "Ondersteunde HVAC-modi: {modes}", "externalConditionTargetTypes": "Ondersteunde doeltypen: {types}", "externalConditionActions": "Ondersteunde schema-acties: {actions}", "externalConditionTurnOffUnsupported": "Uitschakelblokken worden niet ondersteund", "externalConditionOptionFields": "Ondersteunde klimaatopties: {fields}", "externalConditionOptionsUnsupported": "Velden voor klimaatopties worden niet ondersteund", "externalConditionMaxChanges": "Maximaal {count} schemawijzigingen per dag", "externalConditionTimeGrid": "Tijden moeten intervallen van {minutes} minuten gebruiken", "externalConditionMidnightContinuityCounts": "Een impliciete continuïteitswijziging om middernacht telt mee voor het dagelijkse maximum", "externalConditionsUnavailable": "Controllervoorwaarden zijn niet beschikbaar.",
  "externalCapability_action_set_temperature": "Temperatuur instellen", "externalCapability_action_set_hvac_mode": "Alleen HVAC-modus wijzigen", "externalCapability_action_turn_off": "Uitschakelen", "externalCapability_hvac_heat": "Verwarmen", "externalCapability_hvac_cool": "Koelen", "externalCapability_target_scalar": "Enkele doeltemperatuur", "externalCapability_target_range": "Doeltemperatuurbereik",
  "externalProviderAvailability": "Controller: {state}", "externalProviderAvailable": "beschikbaar", "externalProviderUnavailable": "niet beschikbaar", "externalPublication_publishing": "Het effectieve schema wordt naar de externe integratie gepubliceerd.", "externalPublication_published": "De externe integratie heeft het effectieve schema geaccepteerd.", "externalPublication_failed": "Publicatie van het schema is mislukt.", "overviewExternalExecutionProvider": "Externe controller: {provider}", "overviewExternalInfoAction": "Over externe uitvoering via {provider}", "overviewExternalStatusPublishing": "Bezig met publiceren", "overviewExternalStatusAccepted": "Geaccepteerd", "overviewExternalStatusFailed": "Mislukt", "overviewExternalStatusUnavailable": "Niet beschikbaar", "overviewExternalProviderUnavailable": "De externe integratie is momenteel niet beschikbaar. Velair blijft inactief voor deze klimaatentiteit.",
  "externalSystems": "Externe systemen", "externalSystemsDescription": "Kies wie het effectieve weekschema voor compatibele klimaatentiteiten uitvoert. Externe zones worden nooit rechtstreeks door Velair aangestuurd.",
  "externalExecutionVelair": "Velair (lokale uitvoering)", "externalExecutionLocal": "Uitgevoerd door Velair", "externalExecutionEnabled": "Externe uitvoering van schema's ingeschakeld", "externalExecutionDisabled": "Uitvoering van schema's door Velair ingeschakeld", "externalScheduleRequired": "Maak en bewaar een schema met minstens één temperatuurblok voordat je externe uitvoering inschakelt.", "externalSwitchpointUsage": "{used} van {max} schakelmomenten van de controller", "externalSwitchpointBreakdown": "{count} geplande blokken", "externalSwitchpointBreakdownContinuity": "{count} geplande blokken + 1 continuïteitspunt om middernacht", "externalActionsInactive": "Velair-acties zijn inactief omdat deze klimaatentiteit door een extern systeem wordt uitgevoerd.",
  "overviewZoneExternal": "Externe uitvoering", "overviewExternalLabel": "Extern", "overviewExternalExecutionDescription": "De geplande tijdlijn wordt uitgevoerd door de externe controller. Velair stuurt geen klimaatacties naar deze zone.", "overviewExternalZonesUnaffected": "{count} extern uitgevoerde zone(s) worden niet beïnvloed door Velair-acties.", "manualUnavailableExternalExecution": "Handmatige bediening is niet beschikbaar voor extern uitgevoerde klimaatentiteiten.",
  "externalChangePolicy": "Externe aanpassingen",
  "externalChangePolicyDescription": "Kies wat Velair doet na een wijziging van modus of doel buiten Velair. Automatisch behouden past de huidige Velair-instelling opnieuw toe; de andere opties starten handmatige bediening. Wijzigingen gelden vanaf de volgende externe aanpassing. Expliciet Handmatig kiezen blijft actief tot hervatten.",
  ...
  "targetTempStepFallback": "Temperatuurstap",
  "targetTempStepFallbackDescription": "Home Assistant meldt de doeltemperatuurstap van deze klimaatentiteit niet. Velair gebruikt deze waarde totdat de entiteit er een meldt.",
  "targetTempStepFallbackInfoAction": "Over de temperatuurstap",
  "targetTempStepSaved": "Temperatuurstap opgeslagen",
  ...
  "manualUnavailableProfilePause": "Het actieve profiel pauzeert deze klimaatentiteit.",
  ...
  "clonePresetLabel": "Snelle dagselectie",
  "clonePresetWeekdays": "Ma–Vr",
  "clonePresetWeekend": "Weekend",
  "clonePresetAll": "Alle dagen",
  "clonePresetClear": "Selectie wissen",
  "cancel": "Annuleren",
  "close": "Sluiten",
  ...
  "boost": "Tijdelijke aanpassing",
  "boostActive": "Tijdelijke aanpassing actief",
  "activeBoosts": "Actieve tijdelijke aanpassingen",
  "availableModes": "Beschikbare modi",
  "boostTarget": "Doel van tijdelijke aanpassing",
  "boostUntil": "Eindigt over",
  "blocks": "Blokken",
  "build": "Build",
  "cardView": "Kaartweergave",
  "climateCardOutdoorSensorDescription": "Alleen-visuele buitenmeting ter vergelijking met de huidige binnentemperatuur. Dit wijzigt de Velair-regeling niet.",
  "climateCardHeaderOptions": "Koptekst",
  "climateCardShowStateBar": "Statusbalk tonen",
  "climateCardShowName": "Naam van thermostaat tonen",
  "climateCardCustomName": "Aangepaste naam",
  "climateCardShowOperation": "Bedrijfsstatus tonen",
  "climateCardShowCurrentTemperature": "Huidige temperatuur tonen",
  "climateCardShowCurrentHumidity": "Huidige luchtvochtigheid tonen",
  "climateCardShowOutdoorTemperature": "Buitentemperatuur tonen",
  "climateCardShowWindows": "Vensters tonen",
  "climateCardWindowsDescription": "Venstersensoren zijn alleen visueel en regelen Velair niet. Gebruik je eigen Home Assistant-automatisering of de Velair-vensterblueprint als een open venster deze thermostaat moet pauzeren.",
  "climateCardWindowBlueprintLink": "Documentatie bekijken en blueprint importeren",
  "climateCardTimelineShowTitle": "Titel van tijdlijn tonen",
  "climateCardTimelineShowProfile": "Actief profiel tonen",
  "climateCardTimelineShowMode": "Actieve modus tonen",
  "climateCardResetName": "Naam van thermostaat herstellen",
  "climateCardActions": "Acties",
  "climateCardShowBoostAction": "Tijdelijke aanpassing tonen",
  "climateCardShowPauseAction": "Pause- en hervatactie tonen",
  "climateCardVelairActionsDescription": "Tijdelijke aanpassing en pauze worden door Velair geleverd. Gedrag, labels en pictogrammen zijn niet aanpasbaar.",
  "climateCardCustomActions": "Aangepaste acties",
  "climateCardActionsOrderDescription": "Orden Velair-acties en Home Assistant-scripts. Automatische acties gebruiken maximaal drie directe posities; kies Menu Meer om een actie in Meer te houden. De limiet kan niet worden aangepast.",
  "climateCardActionPlacement": "Locatie",
  "climateCardActionPlacementAuto": "Automatisch",
  "climateCardActionPlacementMore": "Menu Meer",
  "climateCardActionPlacementAutoDescription": "Gebruikt een van de eerste drie beschikbare directe posities. Als die bezet zijn, verhuist de actie naar Meer.",
  "climateCardActionPlacementMoreDescription": "Houdt deze actie altijd in het menu Meer, ongeacht de volgorde.",
  "climateCardRemoveCustomAction": "Snelkoppeling van kaart verwijderen",
  "climateCardExpandAction": "{name} bewerken",
  "climateCardCollapseAction": "Instellingen van {name} sluiten",
  "climateCardCollapseCurrentState": "Huidige status inklappen",
  "climateCardExpandCurrentState": "Huidige status uitklappen",
  "climateCardCollapsedByDefault": "Standaard ingeklapt",
  "climateCardCollapseSection": "{name} inklappen",
  "climateCardExpandSection": "{name} uitklappen",
  "climateCardProvidedByVelair": "Geleverd door Velair · het gedrag kan niet worden aangepast",
  "climateCardHideActionName": "Actienaam verbergen",
  "climateCardCustomActionsDescription": "Voeg Home Assistant-scripts toe. De scriptlogica blijft beheerd door Home Assistant.",
  "climateCardAddCustomAction": "Aangepaste actie toevoegen",
  "climateCardNoScripts": "Maak eerst een Home Assistant-script.",
  "climateCardCustomActionName": "Naam",
  "climateCardCustomActionScript": "Home Assistant-script",
  "climateCardCustomActionIcon": "Pictogram",
  "climateCardCustomActionColor": "Pictogramkleur",
  "climateCardCustomActionConfirmation": "Bevestiging vragen voor uitvoeren",
  "climateCardScriptUnavailable": "Script niet beschikbaar",
  "climateCardOpenVelairMenu": "Velair openen",
  "climateCardConfirmScriptAction": "{name} uitvoeren?",
  "climateCardScriptExecuted": "{name} gestart",
  "climateCardPreconditioningDisplay": "Voorconditioneringsweergave",
  "cardViewClimate": "Thermostaat: status en bediening", "climateCardConfiguration": "Thermostaatkaart", "climateCardConfigurationDescription": "Toont één beheerde thermostaat met status, Velair-context en optionele dashboardsensoren.", "climateCardManagedClimate": "Beheerde thermostaat", "climateCardOutdoorSensor": "Buitentemperatuursensor (optioneel)", "climateCardWindowDisplay": "Vensterweergave", "climateCardWindowGrouped": "Groeperen op status", "climateCardWindowIndividual": "Afzonderlijk tonen", "climateCardRoomAssistDisplay": "Room Assist-weergave", "climateCardDisplayBoth": "Tekst en grafiek", "climateCardDisplayChart": "Grafiek", "climateCardDisplayText": "Tekst", "climateCardAddWindow": "Venster toevoegen", "climateCardWindows": "Vensters", "climateCardShowTimeline": "Tijdlijn van vandaag tonen", "climateCardShowComfort": "Welzijn tonen", "climateCardShowCollapsedComfortReadings": "Extra metingen tonen wanneer ingeklapt", "climateCardShowRoomAssist": "Room Assist tonen", "climateCardShowPreconditioning": "Voorconditionering tonen", "climateCardShowActions": "Acties tonen", "climateCardOpenVelair": "Velair openen", "climateCardAvailable": "Beschikbaar", "climateCardUnavailable": "Niet beschikbaar", "climateCardCurrentState": "Huidige status", "climateCardOutdoor": "Buitentemperatuur", "climateCardOutdoorWarmer": "{delta} warmer dan binnen", "climateCardOutdoorColder": "{delta} kouder dan binnen", "climateCardWindowsOpen": "{count} open", "climateCardWindowsClosed": "{count} gesloten", "climateCardWindowsUnavailable": "{count} niet beschikbaar", "climateCardProfilePause": "Profiel {profile} pauzeert deze thermostaat", "climateCardRoomReading": "Kamermeting", "climateCardAppliedSetpoint": "Toegepast setpoint", "climateCardClimateReading": "Thermostaatmeting", "climateCardRoomAssistNotConfigured": "Niet ingesteld", "climateCardRoomAssistDisabled": "Uitgeschakeld", "climateCardRoomAssistIdle": "Inactief", "climateCardRoomAssistReady": "Gereed", "climateCardRoomAssistAssisting": "Corrigeert", "climateCardRoomAssistHolding": "Behoudt", "climateCardRoomAssistBlocked": "Geblokkeerd", "climateCardRoomAssistUnavailable": "Niet beschikbaar", "climateCardExternalManaged": "Beheerd door {provider}", "climateCardExternalControl": "Externe bediening", "climateCardManagePause": "Pauze beheren", "climateCardConfigureBoost": "Versterking instellen", "climateCardBoostStarted": "Versterking gestart", "climateCardBoostCancelled": "Versterking geannuleerd", "climateCardZonePaused": "Thermostaat gepauzeerd", "climateCardZoneResumed": "Thermostaat hervat", "climateCardActionFailed": "Actie kon niet worden voltooid", "resumeAutomaticControl": "Automatisch hervatten", "cancelBoost": "Versterking annuleren", "more": "Meer", "manualControl": "Handmatige bediening", "scheduled": "Gepland", "enabled": "Ingeschakeld", "unavailable": "Niet beschikbaar", "unknown": "Onbekend", "none": "Geen", "remove": "Verwijderen",
  ...
  "cardViewOverviewBoosts": "Overzicht: actieve tijdelijke aanpassingen",
  ...
  "comfortConfiguration": "Comfortconfiguratie",
  "comfortConfigurationDescription": "Sensorbronnen, comfortbereiken en actualiteit van gegevens.",
  "comfortDewPoint": "Dew point",
  "comfortDewPointDescription": "Oppervlakken op of onder het dauwpunt kunnen condens verzamelen. Velair detecteert geen oppervlaktetemperatuur of condensatie.",
  "comfortDewPointBelowRoom": "Het dauwpunt ligt {difference} onder de kamerlucht.",
  "comfortDewPointAboveRoom": "Het dauwpunt ligt {difference} boven de kamerlucht.",
  "comfortAbsoluteHumidity": "Absolute humidity",
  "comfortAbsoluteHumidityDescription": "The actual amount of water vapour in the air.",
  "comfortAbsoluteHumidityNeutral": "Absolute luchtvochtigheid: {value}.",
  ...
  "comfortHumidexRangeBelow": "Onder het ingestelde temperatuurbereik",
  "comfortHumidexRangeWithin": "Binnen het ingestelde temperatuurbereik",
  "comfortHumidexRangeAbove": "Boven het ingestelde temperatuurbereik",
  "comfortHumidexRangeUnknown": "Positie ten opzichte van het ingestelde bereik niet beschikbaar",
  "comfortHumidexScaleAria": "Lucht {air}. Humidex {humidex}. {position}.",
  "comfortHumidexWarmerRelation": "Humidex geeft een gevoelstemperatuur aan die {delta} warmer is dan de kamertemperatuur.",
  "comfortHumidexCoolerRelation": "Humidex ligt {delta} onder de kamertemperatuur.",
  "comfortHumidexNeutralRelation": "Humidex komt overeen met de kamertemperatuur.",
  "comfortRangeWithin": "Binnen geconfigureerde bereiken",
  "comfortRangeOutside": "Buiten geconfigureerde bereiken",
  "comfortRangeMixed": "Verschillende thermische indicatoren",
  "comfortRangeUnavailable": "Beperkte gegevens",
  ...
  "comfortInsightCo2Elevated": "CO2 ligt boven het ingestelde aandachtsniveau.",
  "comfortInsightCo2Poor": "CO2 ligt boven de ingestelde grens voor slechte luchtkwaliteit.",
  "comfortInsightHumidexWarmer": "De luchtvochtigheid verhoogt de gevoelstemperatuur met {delta}.",
  "comfortAir": "Lucht",
  ...
  "comfortModelSimple": "Eenvoudige bereiken",
  "comfortModelSimpleDescription": "Gebruikt hetzelfde vochtigheidsbereik bij elke comfortabele temperatuur.",
  "comfortModelTemperatureAware": "Temperatuurafhankelijke bereiken",
  "comfortModelTemperatureAwareDescription": "Past het toegestane vochtigheidsbereik aan tussen de koele en warme grens van het temperatuurbereik.",
  "comfortTemperatureAwareHumidityRanges": "Temperatuurafhankelijke vochtigheidsbereiken",
  "comfortAtMinimumTemperature": "Bij de koelere grens",
  "comfortAtMaximumTemperature": "Bij de warmere grens",
  "comfortEffectiveHumidityRange": "Bij {temperature} is het comfortabele vochtigheidsbereik {minimum}–{maximum}%.",
  ...
  "noActiveBoosts": "Geen actieve tijdelijke aanpassingen",
  ...
  "overview": "Overzicht",
  "overviewPanelIntro": "De hoofdweergave groepeert de plannerstatus, komende gebeurtenissen, actieve tijdelijke aanpassingen en snelle acties.",
  ...
  "overviewZoneBoost": "Tijdelijke aanpassing",
  ...
  "roomSensorAssist": "Ondersteuning via kamersensor",
  "roomSensorAssistBadge": "Room Assist",
  "roomSensorAssistEnabled": "Ondersteuning via kamersensor ingeschakeld",
  "roomSensorAssistHelp": "Past het klimaatdoel tijdelijk aan zodat de kamersensor de geplande temperatuur kan bereiken.",
  "roomSensorAssistDisabledDetail": "Er is een kamersensor geselecteerd, maar de ondersteuning via kamersensor staat uit. Velair gebruikt de klimaattemperatuur totdat deze schakelaar wordt ingeschakeld.",
  ...
  "roomSensorControl": "Ondersteuning via kamersensor",
  ...
  "roomSensorTemperatureEntityHelp": "Sensor die de ondersteuning via kamersensor als werkelijke kamertemperatuur gebruikt bij het aanpassen van het klimaatdoel.",
  ...
  "diagnosticsSchedulerSummary": "Planner: {status} · Modus: {mode}",
  ...
  "diagnosticsEntityUnavailable": "De klimaatentiteit is niet beschikbaar.",
  "diagnosticsEntityUnknown": "De klimaatentiteit meldt een onbekende status.",
  ...
  "diagnosticsPreconditioning": "Voorconditionering",
  ...
  "diagnosticsDeliveryRetrying": "Velair probeert de laatste intentie voor de klimaatentiteit opnieuw te verzenden.",
  "diagnosticsDeliveryExhausted": "De limiet voor verzendpogingen is bereikt.",
  "diagnosticsDeliveryInvalidIntent": "De huidige intentie voor de klimaatentiteit kon niet worden bepaald.",
  ...
  "diagnosticsUnits": "Beheerde klimaatentiteiten",
  "diagnosticsNoUnits": "Er zijn geen beheerde klimaatentiteiten beschikbaar voor diagnostiek.",
  ...
  "diagnosticsLogClimate": "Klimaatentiteit",
  ...
  "diagnosticsHistorySourceCount": "{count} klimaatentiteiten",
  "diagnosticsHistorySourceCountWithVelair": "{count} klimaatentiteiten + Velair",
  ...
  "diagnosticsHistoryAllSources": "Alle klimaatentiteiten + Velair",
  ...
  "diagnosticsHistoryCategoryControlDescription": "Schema’s, profielen, modi, tijdelijke aanpassingen, pauzes, externe aanpassingen en wijzigingen tussen automatische en handmatige bediening.",
  ...
  "diagnosticsHistoryCategoryPreconditioning": "Voorconditionering",
  "diagnosticsHistoryCategoryPreconditioningDescription": "Plannen, annuleringen en leerwaarnemingen van voorconditionering.",
  ...
  "diagnosticsHistoryCategoryDelivery": "Verzending naar de klimaatentiteit",
  "diagnosticsHistoryCategoryDeliveryDescription": "Mislukte, herhaalde, uitgeputte of geannuleerde opdrachten voor klimaatentiteiten.",
  "diagnosticsHistoryCategoryAvailability": "Beschikbaarheid",
  "diagnosticsHistoryCategoryAvailabilityDescription": "Beheerde klimaatentiteiten die niet beschikbaar of onbekend worden, of weer beschikbaar komen.",
  ...
  "diagnosticsReasonSchedulerNotAuto": "De planner staat niet in de automatische modus",
  ...
  "diagnosticsEventBoostEnded": "Tijdelijke aanpassing beëindigd",
  "diagnosticsEventBoostStarted": "Tijdelijke aanpassing gestart",
  "diagnosticsEventClimateTargetApplied": "Doeltemperatuur van de klimaatentiteit toegepast",
  ...
  "diagnosticsEventProfileChanged": "Profiel gewijzigd",
  "diagnosticsEventSchedulerModeChanged": "Modus van de planner gewijzigd",
  ...
  "diagnosticsEventPreconditioningObservationRecorded": "Waarneming voor voorconditionering vastgelegd",
  "diagnosticsEventPreconditioningPlanCancelled": "Voorconditioneringsplan geannuleerd",
  "diagnosticsEventPreconditioningPlanUpdated": "Voorconditioneringsplan bijgewerkt",
  ...
  "diagnosticsExportExplanation": "De lokale weergave gebruikt echte lokale ID’s. Laat deze optie aan om ID’s van klimaatentiteiten en sensoren in het rapport door stabiele aliassen te vervangen.",
  "diagnosticsRedactEntityIds": "Entiteits-ID’s door aliassen vervangen",
  "diagnosticsOperationalIdsAlwaysRedacted": "Profiel-, modus- en pauze-ID’s worden altijd verwijderd.",
  ...
  "diagnosticsScheduleSourceProfilePause": "Pauze van profiel",
  "diagnosticsOverrideTurnOff": "Klimaatentiteit uitschakelen",
  ...
  "temperatureStepNotReportedDescription": "Deze klimaatentiteit publiceert geen target_temp_step. Velair gebruikt de terugvalwaarde die voor de zone is ingesteld.",
  ...
  "chooseModeForDeviceControlled": "Kies een HVAC-modus voordat je het door het apparaat geregelde doel gebruikt",
  ...
  "schedulerStatuses": {
    "idle": "Inactief",
    "override_active": "Tijdelijke aanpassing actief",
    "paused": "Gepauzeerd",
    "scheduled": "Gepland"
  },
  "schedulerModes": {
  ...
  "climateCardRoomAssistSummaryNotConfigured": "Selecteer een kamertemperatuursensor voordat je Room Assist gebruikt.",
  "climateCardRoomAssistSummaryDisabled": "Room Assist is geconfigureerd, maar momenteel uitgeschakeld.",
  "climateCardRoomAssistSummaryIdle": "Wacht op een actief en compatibel gepland doel.",
  "climateCardRoomAssistSummaryReady": "Klaar om het klimaatdoel aan te passen wanneer de kamertemperatuur dat vereist.",
  "climateCardRoomAssistSummaryAssisting": "Past het klimaatdoel aan om de kamer naar het geplande doel te brengen.",
  "climateCardRoomAssistSummaryHolding": "Houdt het huidige Room Assist-doel stabiel.",
  "climateCardRoomAssistSummaryBlocked": "Wacht terwijl een andere Velair-actie voorrang heeft.",
  "climateCardRoomAssistSummaryUnavailable": "Room Assist kan dit klimaatapparaat momenteel niet regelen.",
  "climateCardPreconditioningActive": "Actief",
  "climateCardRoomAssistSummaryAssistingAdjusted": "Stelt het klimaatdoel in op {applied} om de kamer naar het geplande doel van {target} te brengen.",
  ...
  "comfortDataSources": "Gegevensbronnen",
  "comfortModelGuided": "Begeleid psychrometrisch bereik",
  "comfortModelGuidedDescription": "Past de relatieve luchtvochtigheid vanuit één referentiebereik aan het temperatuurbereik aan.",
  "comfortModelGuidedReference": "Het vochtigheidsbereik is de referentie bij {temperature}; Velair past de doelcurve aan andere temperaturen aan.",
  "comfortModelHumidityRequired": "Voor dit model is een vochtigheidsbron vereist.",
  "comfortGuidedHumidityReference": "Referentiebereik luchtvochtigheid",
  "comfortPreferences": "Welzijnsvoorkeuren",
} as const;
